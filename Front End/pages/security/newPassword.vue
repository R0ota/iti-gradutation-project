        ...
        >
          <div class="flex flex-col gap-4 w-full">
            ...
            >
              <label
                for="password"
                class="px-2 justify-center items-start text-red-900 text-lg font-medium leading-relaxed"
                >Password</label
              >
              <div class="relative w-full">
                ...
                <span
                  class="absolute inset-y-0 right-4 flex items-center text-red-900 cursor-pointer"
            ...
            >
              ...
              <div class="relative w-full">
                <input
                  ...
                  id="confirmPassword"
                  class="w-full placeholder:text-red-900 placeholder:opacity-50 placeholder:text-m font-medium p-3 text-red-900 bg-yellow-50 rounded-2xl outline outline-offset-[-1px] outline-red-800 inline-flex justify-start items-center"
                />
