...
<template>
    <div class="flex justify-between items-center m-[30px] ml-[250px] fixed w-[77%]">
        <!-- form data -->
                ...
                <div class="flex flex-col gap-0.5 w-full">
                    ...
                    <div id="color" class="flex flex-col gap-2 w-full justify-center">
                        <div class="flex flex-row gap-2 w-full items-center">
                            ...
                            <span class="text-black w-full text-center">
                                <div class="relative inline-block group">
                                    <!-- The text -->
                                    <span class="text-blue-600 cursor-pointer">Image Link</span>
