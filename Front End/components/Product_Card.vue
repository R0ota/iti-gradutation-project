...
<template>
    ...
    >
        <div class="relative lg:w-64 w-44 lg:h-64 h-40 lg:rounded-[42.35px] bg-[#D9D9D9] flex-shrink-0 aspect-square 
         rounded-3xl">
            ...
            <div class="group">
                ...
                >
                    <i class="fa-solid fa-heart fill text-[#A31D1D] group-hover:text-orange-100" />
                </div>
                ...
                >
                    <i class="fa-regular fa-heart fill text-red-800 group-hover:text-orange-100 " />
                </div>
            </div>
        ...
        <div class="flex flex-col items-start lg:gap-2 gap-1.5 self-stretch px-1 lg:w-64 w-44">
            ...
            <div class="group-hover:hidden lg:w-8 w-6 lg:h-8 w-6 lg:rounded-xl rounded-lg bg-red-800 p-[3.29px] flex items-center justify-center transition-all duration-300">
                <img src="../assets/cart-shopping-stroke.svg" class="w-4 h-4 lg:w-6 lg:h-5">
            </div>
            <!-- add to cart -->
            <div class="hidden group-hover:flex px-2 flex items-center justify-start gap-1 rounded-[50px] bg-red-800 transition-all duration-300">
                <div class="lg:w-8 w-6 lg:h-8 w-6 lg:rounded-xl rounded-lg bg-red-800  flex items-center justify-center">
                <img src="../assets/cart-shopping-white.svg" class="w-4 h-4 lg:w-6 lg:h-5">
            </div>
            <p class="text-orange-100 text-base font-medium font-['Poppins']">Add to Cart</p>
            </div>
            </div>
