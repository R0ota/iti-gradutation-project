  ...
  <div class="flex flex-col items-center justify-center lg:gap-2 gap-1.5 group">
    ...
    >
      ...
      <img
        ...
        :src="image"
        class="lg:w-64 w-42 lg:h-64 h-40 lg:rounded-[40px] rounded-[25.197px] cursor-pointer"
      />
    ...
    >
      <div class="flex flex-col  gap-0.5 justify-start items-start">
        <p
          @click="navigateToProduct(id)"
          class="lg:text-xl lg:tracking-[-0.342px] font-bold leading-7 text-xs  cursor-pointer text-red-900 "
        >
          {{ title }}
        </p>
        <p
